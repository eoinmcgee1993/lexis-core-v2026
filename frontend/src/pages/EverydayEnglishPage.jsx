...
export default function EverydayEnglishPage({ navigateTo, lang = 'en' }) {
  ...
  useSeo({
    ...
    description: lang === 'th'
      ? `ฝึกพูดภาษาอังกฤษในชีวิตประจำวันออกเสียงจริง กิจวัตรประจำวัน ครอบครัว งานอดิเรก อาหาร และสภาพอากาศ พร้อมคำแนะนำแบบเรียลไทม์อย่างอ่อนโยน ทดลองใช้ฟรี ${TRIAL.minutes} นาที ไม่ต้องผูกบัตร`
      : `Practice everyday English conversation out loud, daily routine, family, hobbies, food, and weather, with gentle real-time corrections. Free ${TRIAL.minutes}-minute trial, no card required.`,
    canonical: pageUrl,
    htmlLang: lang,
    hreflang: [
