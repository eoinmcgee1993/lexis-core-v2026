...
// PREVIEW (21 Aug 2026): the hero portrait these constants fed is
// currently swapped out for HeroLiveDemo (see the hero section below) —
// kept here, unused, rather than deleted, since this is a preview branch
// and the photo needs to be one PR-revert away, not a re-fetch/regenerate
// away, if the running-demo idea doesn't ship as-is. Was generated the
// same way as the in-app avatar photos (see
  ...
  return (
    <div className="min-h-screen lexis-canvas-gradient text-lexis-ink font-sans">
      ...
      <section className="w-full max-w-6xl mx-auto px-6 py-16 md:py-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        {/* PREVIEW (21 Aug 2026): the static portrait is swapped here for
            HeroLiveDemo — the interface re-audit's recommendation 01,
            "put the conversation in the hero, running." This branch is
            NOT auto-merged; it exists so the real thing can be looked at
            before deciding whether to ship it, per direct instruction to
