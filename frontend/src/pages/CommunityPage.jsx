...
const TEXT = {
  en: {
    ...
    whereBody: 'Every sponsor contribution lands in one shared pool, not a separate account tied to one student. As that pool grows, it covers the cost of real LEXIS access for real students through partner schools and youth organizations, discounted or free seats for a whole group, not one-off case-by-case requests. No hidden layer, no admin fee skimmed off the top: sponsorships in, funded access out, for as many students as the pool can currently support.',
    ...
    seoDescription: 'LEXIS Community: every pass can help fund free and discounted spoken-practice access for students and youth groups who couldn’t otherwise afford it.'
  },
  th: {
    home: 'หน้าแรก',
    badge: 'LEXIS Community',
    ...
    whereBody: 'เงินสนับสนุนทุกบาทเข้ากองทุนเดียวกัน ไม่ใช่บัญชีแยกผูกกับนักเรียนคนใดคนหนึ่ง เมื่อกองทุนโตขึ้น จะครอบคลุมค่าใช้จ่ายให้นักเรียนจริงเข้าถึง LEXIS ได้จริงผ่านโรงเรียนและกลุ่มเยาวชนพันธมิตร เป็นที่นั่งลดราคาหรือฟรีให้ทั้งกลุ่ม ไม่ใช่คำขอเป็นรายกรณี ไม่มีชั้นซ่อนเร้น ไม่มีค่าธรรมเนียมบริหารหักออก เงินสนับสนุนเข้ามา ทุนการเข้าถึงออกไป เท่าที่กองทุนรองรับได้ในตอนนั้น',
